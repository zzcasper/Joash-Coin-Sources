...
"""Verify that starting jnitacoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start jnitacoin with -h for help text")
        ...
        self.log.info("Start jnitacoin with -version for version information")
