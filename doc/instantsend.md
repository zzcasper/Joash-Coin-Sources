...
This mechanism has been integrated into Bitcore-Node-JoashCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/joashcoinpay/insight-api-joashcoin#web-socket-api](https://github.com/joashcoinpay/insight-api-joashcoin#web-socket-api)
* API: [https://github.com/joashcoinpay/insight-api-joashcoin#instantsend-transactions](https://github.com/joashcoinpay/insight-api-joashcoin#instantsend-transactions)
...
By default, the JoashCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the JoashCoin Core daemon:
