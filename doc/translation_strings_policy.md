...
This document provides guidelines for internationalization of the JoashCoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `joashcoin_en.ts` remains unchanged.
