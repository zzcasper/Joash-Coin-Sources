...
* jnitacoin.conf: contains configuration settings for jnitacoind or jnitacoin-qt
* jnitacoind.pid: stores the process id of jnitacoind while running
...
* debug.log: contains debug information and general logging generated by jnitacoind or jnitacoin-qt
