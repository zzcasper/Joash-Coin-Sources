...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid joashcoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid joashcoin address" in e.error['message'])
