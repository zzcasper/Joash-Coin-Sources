    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("JCN-light"), QVariant("light"));
    ui->theme->addItem(QString("JCN-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("JCN-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("JCN-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("JCN-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("JCN-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("JCN-traditional"), QVariant("trad"));
