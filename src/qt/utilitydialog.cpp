    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  joashcoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the JoashCoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 JCN, 0.1 JCN, 1 JCN and 10 JCN -- sort of like the paper money you use every day.</li> \
