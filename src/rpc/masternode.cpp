...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print JoashCoin address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "joashcoin",               "masternode",             &masternode,             true,  {} },
    { "joashcoin",               "masternodelist",         &masternodelist,         true,  {} },
    { "joashcoin",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "joashcoin",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "joashcoin",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "joashcoin",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
