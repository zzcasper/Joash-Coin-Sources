...
UniValue gobject(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp  ||
        ...
        throw std::runtime_error(
                ...
                "  vote-conf          - Vote on a governance object by masternode configured in joashcoin.conf\n"
    ...
    */
    ...
    if(strCommand == "vote-conf")
    {
        ...
        if(!fMnFound) {
            ...
            resultsObj.push_back(Pair("joashcoin.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    /* JoashCoin features */
    { "joashcoin",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "joashcoin",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "joashcoin",               "gobject",                &gobject,                true,  {} },
    { "joashcoin",               "voteraw",                &voteraw,                true,  {} },
