...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s jnitacoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  jnitacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded jnitacoin transaction") + "\n" +
              "  jnitacoin-tx [options] -create [commands]   " + _("Create hex-encoded jnitacoin transaction") + "\n" +
              "\n";
