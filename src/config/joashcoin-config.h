/* src/config/joashcoin-config.h.  Generated from joashcoin-config.h.in by configure.  */
/* src/config/joashcoin-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The JoashCoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "JoashCoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/joashcoinpay/joashcoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "JoashCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "JoashCoin Core 0.12.3"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "joashcoincore"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://joashcoin.org/"
