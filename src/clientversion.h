...
//! These need to be macros, as clientversion.cpp's and joashcoin*-res.rc's voodoo requires it
...
/**
 * joashcoind-res.rc includes this file, but it cannot cope with real c++ code.
