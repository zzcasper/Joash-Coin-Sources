...
official/supported Docker Images found at https://hub.docker.com/r/joashcoinpay/joashcoind/
...
**NOTE: Please update the image description at https://hub.docker.com/r/joashcoinpay/joashcoind-develop/ when changing the above text**